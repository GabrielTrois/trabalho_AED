...
int main() {
    ...
    while(1){
        if(tipoEquipe == 1){
            ...
            printf("Gerencie sua Pokedex:\n\n");
            printf("Mudar para Equipe - 0\n");
            printf("Ver Pokedex - 1\n");
            printf("Exibir mais forte - 2\n");
            printf("Exibir mais fraco - 3\n");
            printf("Exibir Pokemon por nome - 4\n");
            printf("Exibir Pokemon por posicao - 5\n\n");
            ...
            switch(op){
                ...
                case 2:
                    printf("Seu Pokemon mais forte eh: \n");
                    imprimeMinMaxTotal(lista, 1);
                    break;
                case 3:
                    printf("Seu Pokemon mais fraco eh: \n");
                    imprimeMinMaxTotal(lista, 2);
                    break;
                case 4:
                    printf("Digite o nome do Pokemon: ");
                    scanf("%s", nome);
                    imprimeNoByPosition(lista, getPositionByName(lista, nome)-1);
                    break;
                case 5:
                    printf("Digite a posicao do Pokemon: ");
                    scanf("%d", &position);
                    imprimeNoByPosition(lista, position-1);
                    break;
                default:
                    printf("Digite uma operacao valida");
                    break;
